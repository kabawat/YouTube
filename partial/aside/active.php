<div class="side_active">
        ...
        <div class="active_menu">
            <div class="icon">
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"
                    ...
                    style="pointer-events: none; display: block; width: 100%; height: 100%;">
                    <g class="style-scope yt-icon">
                        <path d="M12,15.7L5.6,9.4l0.7-0.7l5.6,5.6l5.6-5.6l0.7,0.7L12,15.7z" class="style-scope yt-icon">
                        </path>
                    </g>
                </svg>
            </div>
    ...
    <!-- if user log out then show  -->
    <?php if ($logIn==false) { ?>
    <div class="active_list singout_list ">
        <p class="logout_para">
            Sign in to like videos,<br> comment, and subscribe.
        </p>
        <div class="yt_signin_btn">
            <button id="signin_btn_aside">
                <div class="path">
                    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"
                        class="style-scope yt-icon"
                        style="pointer-events: none; display: block; width: 100%; height: 100%;">
    ...
    <!-- BEST OF YOUTUBE in user log out  -->
    <?php 
    if ($logIn==false) { 
        $i;
        $list = array("Music","Sports", "Gaming", "Movies", "News", "Live", "Fashion & Beauty", "Learning", "Spotlight", "360° Video");
        ?>
    <div class="active_list ">
        <h3 class="SUB_aside">BEST OF YOUTUBE</h3>
        ...
        <div class="active_menu">
            <div class="yt_sub_icon">
                <img src="<?php echo'img/aside/icon_'.$i.'.jpg'?>" alt="">
            </div>
    ...
    <!-- SUBSCRIPTIONS in user log in  -->
    <?php if($logIn==true){?>
    <div class="active_list ">
        <h3 class="SUB_aside">SUBSCRIPTIONS</h3>
        <!-- subscribe chennal list  -->
        <?php include "subscibe_list.php";?>
